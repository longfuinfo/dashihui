...
package com.dashihui.afford.thirdapi.addressPicker.widget;
...
import com.dashihui.afford.thirdapi.addressPicker.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	//*/
//	private int[] SHADOWS_COLORS = new int[] { 0x0000000, 0x0000000, 0x0000000 };
	private int[] SHADOWS_COLORS = new int[] { 0x3f55555, 0xcf55555, 0x3f55555 };
...
//		int itemsHeight = height + 2 * PADDING;
	...
	private void drawShadows(Canvas canvas) {
		...
		//*/
		int height = (int)(4 * getItemHeight());
		//*/
