...
public class ViewMiddleRight extends RelativeLayout implements ViewBaseAction{
    ...
    public ViewMiddleRight(BaseActivity context) {
        super(context);
        init(context);
    }

    public ViewMiddleRight(BaseActivity context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public ViewMiddleRight(BaseActivity context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
