...
//	private OnSelectListener mOnSelectListener;
	...
	public ViewRight(BaseActivity context) {
		super(context);
		init(context);
	}

	public ViewRight(BaseActivity context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public ViewRight(BaseActivity context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
