...
import com.dashihui.afford.ui.activity.fragment.FragmentDiscount;
import com.dashihui.afford.ui.widget.WdtPagerSlidingTabStrip;


public class AtyFragmentDiscount extends BaseAtyFragment implements OnClickListener {
	...
	public class MyPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			return CommConstans.COMMONARRAY.TABS_DISCOUNT[position];
		}

		@Override
		public int getCount() {
			return CommConstans.COMMONARRAY.TABS_DISCOUNT.length;
		}
		...
		public Fragment getItem(int position) {
			...
			case 1:
			case 2:
				fragment = FragmentDiscount.newInstance(AtyFragmentDiscount.this, position);
				break;
			default:
				break;
			}
