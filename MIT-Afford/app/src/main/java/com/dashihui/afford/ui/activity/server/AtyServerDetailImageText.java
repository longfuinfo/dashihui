...
public class AtyServerDetailImageText extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String goodsID = getIntent().getStringExtra(AtyServerList.INTENT_SERVER_ID);
        mBllServer.getDescribe(goodsID);
    }
    ...
    public void onSuccess(EtySendToUI beanSendUI) {
        if (beanSendUI!=null){
            switch (beanSendUI.getTag()){
                case AffConstans.BUSINESS.TAG_SERVICE_DESCRIBE://商家详情描述
