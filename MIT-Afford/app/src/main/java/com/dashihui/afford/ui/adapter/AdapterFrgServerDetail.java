 ...
 * @date 2015-10-30
 */
public class AdapterFrgServerDetail extends AdapterBase<Map<String, String>> {

    public AdapterFrgServerDetail(Activity context, List<Map<String, String>> _List) {
        super(context, _List);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.frag_server_detail_item, null);
    ...
    static class ViewHolder {
        ...
        public void refresh(final int position) {
            if (!UtilList.isEmpty(mListMap)){
                ...
                LogUtils.e("refresh==========mTxtViewName===========>" + mListMap.get(position).get("name") + "");
                LogUtils.e("refresh==========mTxtViewDate===========>" + mListMap.get(position).get("content") + "");
            }else{
