 ...
 * @date 2015-10-30
 */
public class AdapterFrgServerState extends AdapterBase<Map<String, String>> {

    public AdapterFrgServerState(Activity context, List<Map<String, String>> _List) {
        super(context, _List);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.frag_server_state_item, null);
    ...
    static class ViewHolder {
        ...
        public void refresh(final int position) {
            if (!UtilList.isEmpty(mListMap)){
                ...
                mTxtViewDate.setText(mListMap.get(position).get("date") + "");
            }else{
