 ...
 */
public class AdapterLocation extends AdapterBase<Map<String,Object>> {


    private List<Map<String, Object>> listObject;
    public AdapterLocation(Activity context, List<Map<String, Object>> _mList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.aty_location_item, null);
    ...
    static class ViewHolder {
        ...
        public void refresh(final int position) {
            if (!UtilList.isEmpty(mListMap)){
                ...
                LogUtils.e("refreshLocation===========title==========>" + mListMap.get(position).get("title") + "");
                mAddress.setText(mListMap.get(position).get("address")+"—距离"+mListMap.get(position).get("distance")+"米");
            }else{
