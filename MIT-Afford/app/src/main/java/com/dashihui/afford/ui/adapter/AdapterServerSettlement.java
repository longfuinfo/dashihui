...
import com.dashihui.afford.ui.activity.server.AtyServerSettlement;
 ...
 */
public class AdapterServerSettlement extends AdapterBase<Map<String,Object>> {


    private List<Map<String,Object>> listObject;
    public AdapterServerSettlement(Activity context, List<Map<String,Object>> _mList) {
    ...
    static class ViewHolder {
        ...
        public void refresh(int position) {
            if (!UtilList.isEmpty(mListMap)){
                mGoodsName.setText(mListMap.get(position).get(AtyServerSettlement.INTENT_TITLE)+"");
                mPrice.setText("￥"+mListMap.get(position).get(AtyServerSettlement.INTENT_SELLPRICE));
            }else{
