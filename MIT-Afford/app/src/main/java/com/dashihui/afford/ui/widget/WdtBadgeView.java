 ...
 * @author Jeff Gilfelt
 */
public class WdtBadgeView extends TextView {
    ...
    public WdtBadgeView(Context context) {
        this(context, (AttributeSet) null, android.R.attr.textViewStyle);
    }

    public WdtBadgeView(Context context, AttributeSet attrs) {
     ...
     */
    public WdtBadgeView(Context context, View target) {
     ...
     */
    public WdtBadgeView(Context context, TabWidget target, int index) {
        this(context, null, android.R.attr.textViewStyle, target, index);
    }

    public WdtBadgeView(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs, defStyle, null, 0);
    }

    public WdtBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
