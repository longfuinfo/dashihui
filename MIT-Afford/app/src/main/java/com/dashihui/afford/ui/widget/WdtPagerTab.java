...
public class WdtPagerTab extends ViewGroup {
    ...
    private BaseAtyFragment mActivity;
    ...
    private int mIndicatorColor = 0xFFC52720;//指示器颜色
    ...
    public WdtPagerTab(Context context) {
        this(context, null);
    }

    public WdtPagerTab(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WdtPagerTab(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        if (context instanceof BaseAtyFragment) {
            mActivity = (BaseAtyFragment) context;
        }
        init();
        initPaint();
    }
    ...
    private void addTextTab(final int position, String title) {
        ...
        tab.setTextColor(getColorStateList(mTabTextColorResId));
        tab.setBackgroundDrawable(getDrawable(mTabBackgroundResId));
