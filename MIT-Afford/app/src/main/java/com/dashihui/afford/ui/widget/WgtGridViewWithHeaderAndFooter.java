 ...
 * See {@link WgtGridViewWithHeaderAndFooter#addHeaderView(View, Object, boolean)}
 * See {@link WgtGridViewWithHeaderAndFooter#addFooterView(View, Object, boolean)}
 */
public class WgtGridViewWithHeaderAndFooter extends GridView {
    ...
    public WgtGridViewWithHeaderAndFooter(Context context) {
        super(context);
        initHeaderGridView();
    }

    public WgtGridViewWithHeaderAndFooter(Context context, AttributeSet attrs) {
        super(context, attrs);
        initHeaderGridView();
    }

    public WgtGridViewWithHeaderAndFooter(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void addHeaderView(View view, Object data, boolean isSelectable) {
        ...
        ViewGroup.LayoutParams lyp = view.getLayoutParams();

        FixedViewInfo info = new FixedViewInfo();
        FrameLayout fl = new FullWidthFixedViewLayout(getContext());
        if (lyp != null) {
            view.setLayoutParams(new FrameLayout.LayoutParams(lyp.width, lyp.height));
    ...
    private class FullWidthFixedViewLayout extends FrameLayout {
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            int realLeft = WgtGridViewWithHeaderAndFooter.this.getPaddingLeft() + getPaddingLeft();
        ...
        @Override
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            int targetWidth = WgtGridViewWithHeaderAndFooter.this.getMeasuredWidth()
                    - WgtGridViewWithHeaderAndFooter.this.getPaddingLeft()
                    - WgtGridViewWithHeaderAndFooter.this.getPaddingRight();
...
//            return (int) (Math.ceil(1f * mAdapter.getCount() / mNumColumns) * mNumColumns);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            // Header (negative positions will throw an ArrayIndexOutOfBoundsException)
            int numHeadersAndPlaceholders = getHeadersCount() * mNumColumns;
            if (numHeadersAndPlaceholders == 1){
                position = 0;
            }
            if (position < numHeadersAndPlaceholders) {
