...
public abstract class TACommand extends TABaseCommand
{
    ...
    public void sendSuccessMessage(Object object) {
        this.sendSuccessMessage(object, null);
    }

    public void sendFailureMessage(Object object) {
        this.sendFailureMessage(object, null);
    }

    public void sendRuntingMessage(Object object) {
        this.sendRuntingMessage(object, null);
    }

	public void sendSuccessMessage(Object object, Object tag)
	{
	...
	public void sendFailureMessage(Object object, Object tag)
	{
		TAResponse response = new TAResponse();
		response.setData(object);
        response.setTag(tag);
	...
	public void sendRuntingMessage(Object object, Object tag)
	{
		TAResponse response = new TAResponse();
		response.setData(object);
        response.setTag(tag);
